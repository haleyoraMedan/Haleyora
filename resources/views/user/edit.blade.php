...
<head>
    ...
    <style>
        ...
        .container { background: #fff; padding: 20px; border-radius: 6px; width: 400px; }
        label { display: block; margin-top: 10px; }
        input, select { width: 100%; padding: 8px; margin-top: 5px; }
        button { margin-top: 15px; padding: 8px; width: 100%; background: #28a745; color: white; border: none; border-radius: 4px; }
